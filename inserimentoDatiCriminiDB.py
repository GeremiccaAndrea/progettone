...
def insert_crime_data(city_name, crime_file, crime_url):
    ...
    collection = db[f"crimini_{city_name.lower()}"]  # Nome collezione basato sulla città
    ...
    print(f"Dati dei crimini per {city_name} inseriti con successo nella collezione 'crimini_{city_name.lower()}'.")
